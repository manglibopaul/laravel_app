            ...
            <form action="{{ route('tasks.update', $task) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">{{ old('description', $task->description) }}</textarea>
                </div>
                ...
                <div class="flex items-center gap-3 pt-2">
                    <button type="submit"
                            class="bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-medium px-5 py-2 rounded-lg shadow transition">
                        Update Task
                    </button>
